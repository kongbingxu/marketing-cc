...
@AllArgsConstructor
@NoArgsConstructor
public class GuoMeiBlackResponseDTO extends ResponseCustomDTO {
    ...
    public GuoMeiBlackResponseDTO success() {
        this.code = ResultEnum.SUCCESS.getCode();
        this.msg = ResultEnum.SUCCESS.getDesc();
        return this;
    }

    public GuoMeiBlackResponseDTO failed(String message) {
        this.code = ResultEnum.FAILED.getCode();
        this.msg = ResultEnum.FAILED.getDesc().concat(message);
        return this;
    }

    public GuoMeiBlackResponseDTO failed() {
        this.code = ResultEnum.FAILED.getCode();
        this.msg = ResultEnum.FAILED.getDesc();
        return this;
    }

    public GuoMeiBlackResponseDTO failed(ResultEnum resultEnum) {
        this.code = resultEnum.getCode();
        this.msg = resultEnum.getDesc();
        return this;
    }

    public GuoMeiBlackResponseDTO failed(ResultEnum resultEnum, String msg) {
        this.code = resultEnum.getCode();
