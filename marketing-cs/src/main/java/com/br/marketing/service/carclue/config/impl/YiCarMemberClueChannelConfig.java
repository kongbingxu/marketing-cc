...
/**
 * @ClassName YiCarMemberClueChannelConfig
 * @Description TODO
 * @Author kongbx
...
@Service
@Slf4j
public class YiCarMemberClueChannelConfig extends AbstractClueChannelConfig {
    @Resource
    ...
    @Override
    public String label() {
        return ChannelRule.ConfigChannelRuleEnum.YC_MEMBER_CONFIG.getLabel();
    }
}
