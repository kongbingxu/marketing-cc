...
@RocketMQMessageListener(topic = MarketingAssistConstants.TOPIC,
        ...
        selectorExpression = MarketingAssistConstants.TAG_CHECK_QUEUE,
        consumeThreadNumber = 1, consumeThreadMax = 1, awaitTerminationMillisWhenShutdown = 10000)
public class CheckQueueConsumer extends BaseMqMessageListener implements RocketMQListener<MessageExt>, RocketMQPushConsumerLifecycleListener {
