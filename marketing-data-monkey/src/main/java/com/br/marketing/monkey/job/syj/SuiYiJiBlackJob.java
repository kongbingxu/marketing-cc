...
@Component
@Slf4j
public class SuiYiJiBlackJob extends AbstractSimpleElasticJob {
    ...
    public void process(JobExecutionMultipleShardingContext shardingContext) {
        ...
        suiYiJiService.blackToUpload(apiCode);
        Long end = System.currentTimeMillis();
        log.warn("随忆记黑名单job执行结束，耗时:{}", end - start);
    }
}
