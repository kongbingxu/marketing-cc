...
import com.br.marketing.service.Impl.wuba.WuBaOldQueryConversionZipResultService;
...
/**
 * @Description 58老客转化数据zip包清洗
 * @Author lixiang
 * @Date 2024-11-19
 */
@Component
@Slf4j
public class WuBaOldQueryConversionZipResultJob extends AbstractSimpleElasticJob {

    private final static String TITLE = "【58老客转化数据zip包清洗】";

    @Resource
    private MarketingCommonConfig marketingCommonConfig;

    @Resource
    private WuBaOldQueryConversionZipResultService service;
    ...
    private boolean checkJobSwitch(){
        String jobSwitch = marketingCommonConfig.getWuBaOldQueryConversionZipResultSwitch();
    ...
    private void action(Map<String, String> param) {
        ...
        // actionFront
        int actionType = JobManager.ActionTypeEnum.WUBA_OLD_QUERY_CONVERSION_ZIP_RESULT.getActionType();
    ...
    private List<Map<String, String>> parseParameter() throws Exception {
        ...
        List<Map<String, String>> configList = marketingCommonConfig.getWuBaOldQueryConversionZipResultParams();
