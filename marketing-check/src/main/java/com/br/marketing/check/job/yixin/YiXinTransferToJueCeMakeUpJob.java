...
@Component
@Slf4j
public class YiXinTransferToJueCeMakeUpJob extends AbstractSimpleElasticJob {
...
//    }
    ...
    @Resource
    private YiXinToJueCeMakeUpProcessService yiXinToJueCeMakeUpProcessService;
    ...
    public void process(JobExecutionMultipleShardingContext context) {
        try {
            ...
            yiXinToJueCeMakeUpProcessService.doProcess(context.getJobParameter());
        } catch (Exception e) {
