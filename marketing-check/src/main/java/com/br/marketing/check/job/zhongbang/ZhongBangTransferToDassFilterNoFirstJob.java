 ...
 * @Description: 众邦转化数据推人工转化过滤接口(非首次)
 **/
@Component
@Slf4j
public class ZhongBangTransferToDassFilterNoFirstJob extends AbstractSimpleElasticJob {
    @Resource
    ...
    public void process(JobExecutionMultipleShardingContext context) {
        try {
            ...
            zhongBangToDassFilterProcessService.doProcessNoFirst(requestDate);
        } catch (Exception e) {
