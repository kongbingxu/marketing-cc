...
public class MarketingPushDaasTransferConsumer extends BaseMqMessageListener implements RocketMQListener<MessageExt>, RocketMQPushConsumerLifecycleListener {
    ...
    protected void handleMessage(MessageExt messageExt) {
        ...
        consumerService.consumerRun(messageExt, pushDataService::pushDassTransferData, o);
    }
